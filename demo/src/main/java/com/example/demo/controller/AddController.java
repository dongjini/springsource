...
public class AddController {
    ...
    public String postCalc(CalcDTO calcDTO) {
        ...
        log.info("연살결과 {} {} {} = {}", calcDTO.getNum1(), calcDTO.getOp(), calcDTO.getNum2(), result);
        calcDTO.setResult(result);
        // template 찾기
        // http://localhost:8080/calc + void => /template/calc.html
        return "result";
        // http://localhost:8080/calc + String => /template/result.html
    }
