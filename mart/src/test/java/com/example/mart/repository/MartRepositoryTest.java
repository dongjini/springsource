...
public class MartRepositoryTest {
    ...
    public void testOrderInsert() {
        ...
        OrderItem orderItem = OrderItem.builder()
                .item(itemRepository.findById(7L).get())
                .order(order)
                .orderPrice(39000)
                .count(1)
                .build();
        ...
        orderItem = OrderItem.builder()
                .item(itemRepository.findById(8L).get())
                .order(order)
                .orderPrice(45000)
                .count(1)
                .build();
    ...
    public void testRead3() {
        ...
        // 주문 상품의 상품명 조회
        System.out.println(orderItem.getItem().getName()); // 티서츠1
    ...
    public void testCategoryItemInsert1() {
        ...
        // 아이템 입력
        Item item1 = Item.builder().name("TV").price(25000000).stockQuantity(15).build();
    ...
    public void joinTest() {
        List<Object[]> list = orderRepository.joingTest();
