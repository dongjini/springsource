...
public class BoardService {
        ...
        // 삭제
        @Transactional // Reply, BoardTBL 두개의 테이블 접근 => 한꺼번에 처리(하나라도 오류나면 롤백)
        public void delete(Long bno) {
                // 연관관계 데이터 정리 => 댓글
                // SQL : 댓글 선 삭제 후 게시글 삭제 or 댓글 부모를 nul로 변경 후 삭제
        ...
        public BoardDTO getRow(Long bno) {
                ...
                // [Board(bno=2, title=Board Title2, content=Board Content2),
                // Member(email=user8@gamil.com, password=1111, name=USER8), 11]
